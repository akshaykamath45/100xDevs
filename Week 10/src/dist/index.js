    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent(); // Ensure client connection is established
                    insertQuery = "INSERT INTO users (username, email, password) VALUES ('username3', 'user4@example.com', 'user_password');";
                ...
                case 3:
                    err_1 = _a.sent();
                    console.error('Error during the insertion:', err_1);
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, client.end()];
                case 5:
                    _a.sent(); // Close the client connection
                    return [7 /*endfinally*/];
